(function (root, factory) {
  ...
  var AssertionError_init_$Create$ = kotlin_kotlin.$_$.a;
  var Unit_getInstance = kotlin_kotlin.$_$.b;
  var objectMeta = kotlin_kotlin.$_$.g;
  var to = kotlin_kotlin.$_$.l;
  var mapOf = kotlin_kotlin.$_$.c;
  //endregion
  ...
  function assertNotEquals_0(illegal, actual, message) {
    get_asserter().assertNotEquals_93hflx_k$(message, illegal, actual);
  }
  function assertNotEquals$default(illegal, actual, message, $mask0, $handler) {
    if (!(($mask0 & 4) === 0))
      message = null;
    return assertNotEquals_0(illegal, actual, message);
  }
